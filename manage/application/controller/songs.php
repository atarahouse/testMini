...
class Songs extends Controller
{
    ...
    public $songs , $amount_of_songs = null;

    function __construct()
    {
        $this->titlePage = "Songs";
    ...
    public function index()
    {
        ...
        $this->songs = $this->songModel->getAllSongs();
        $this->amount_of_songs = $this->songModel->getAmountOfSongs();

       // load views. within the views we can echo out $songs and $amount_of_songs easily    
       $this->loadView('songs/index');   
    ...
    public function addSong()
    {
        ...
        if (isset($_POST["submit_add_song"])) {
            ...
            $this->songModel->addSong($_POST["artist"], $_POST["track"],  $_POST["link"]);
        }
    ...
    public function deleteSong($song_id)
    {
        ...
        if (isset($song_id)) {
            ...
            $this->songModel->deleteSong($song_id);
        }
    ...
    public function updateSong()
    {
        ...
        if (isset($_POST["submit_update_song"])) {
            ...
            $this->songModel->updateSong($_POST["artist"], $_POST["track"],  $_POST["link"], $_POST['song_id']);
        }
    ...
    {
        $amount_of_songs = $this->songModel->getAmountOfSongs();
